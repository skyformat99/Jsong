...
gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c %BIG_NUMBERS% %JSONG%/json/json.c -o build\json.o 2> build\json.log
...
gcc -mconsole ^
  build\json.o build\dom.o build\utils.o build\serialize.o build\errors.o ^
  build\io.o build\console.o -o json %LIBQUADMATH% -lmingw32 -lmsvcr120
