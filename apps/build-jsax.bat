...
gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DJSON_SAX -DJSON_STREAM -DJSON_STRING_NUMBERS -DJSON_VALID_WHITESPACE -DJSON_LINE_COL ^
  %JSONG%/json/parse.c -o build\jsax.o 2> build\jsax.log
...
gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DJSON_STREAM %JSONG%/json/utils/uncomment.c -o build\uncomment.o 2> build\uncomment.log
...
gcc -mconsole ^
  build\jsax.o build\sax.o build\uncomment.o build\escape.o build\serialize.o ^
  build\errors.o build\formatter.o -o jsax -lmingw32 -lmsvcr120
