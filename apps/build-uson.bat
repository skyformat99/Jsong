...
gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %BIG_NUMBERS% %JSONG%/json/parse.c -o build\json.o 2> build\json.log
if %ERRORLEVEL% neq 0 (echo "Build error: json.o" && exit /b %ERRORLEVEL%)

gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %BIG_NUMBERS% %JSONG%/json/dom.c -o build\dom.o 2> build\dom.log
if %ERRORLEVEL% neq 0 (echo "Build error: dom.o" && exit /b %ERRORLEVEL%)

:: Build the JSON processing utilities

gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %JSONG%/json/utils/uncomment.c -o build\uncomment.o 2> build\uncomment.log
if %ERRORLEVEL% neq 0 (echo "Build error: uncomment.o" && exit /b %ERRORLEVEL%)

gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %JSONG%/json/utils/escape.c -o build\escape.o 2> build\escape.log
if %ERRORLEVEL% neq 0 (echo "Build error: escape.o" && exit /b %ERRORLEVEL%)

gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %JSONG%/json/utils/encode.c -o build\encode.o 2> build\encode.log
if %ERRORLEVEL% neq 0 (echo "Build error: encode.o" && exit /b %ERRORLEVEL%)

:: Build the DOM JSON serializer

gcc -O3 %MARCH% -fno-align-labels -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %BIG_NUMBERS% %JSONG%/json/serialize/dom.c -o build\serialize.o 2> build\serialize.log
...
gcc -O3 %MARCH% -I%QUANTUM% -I%ULTRAVIOLET% -I%JSONG% ^
  -c -DENABLE_USON %BIG_NUMBERS% json.c -o build\console.o 2> build\console.log
if %ERRORLEVEL% neq 0 (echo "Build error: console.o" && exit /b %ERRORLEVEL%)

:: Link everything together

gcc -mconsole ^
  build\json.o build\dom.o build\uncomment.o build\escape.o build\encode.o build\serialize.o ^
